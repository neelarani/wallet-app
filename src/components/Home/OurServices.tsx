...
const OurServices = () => {
  ...
  // Group services by 3 for card layout
  ...
  return (
    <div className="bg-primary py-7 md:py-14 my-24 px-4 md:px-20">
      ...
      <div className="md:hidden space-y-6">
        {chunkedServices.map((group, idx) => (
          <div
            key={idx}
            className=" rounded-xl shadow-lg p-6 flex justify-around"
          >
      ...
      {/* Medium+ screens: Flex layout with arrows */}
