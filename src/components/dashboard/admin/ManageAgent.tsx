...
const ManageAgent = () => {
  ...
  return (
    <div className="my-24">
      <h1 className="text-xl md:text-2xl">Manage Agents</h1>
      <p className="block text-base md:text-lg text-gray-500 mt-2">
        Oversee all agents, assign tasks, track performance, and update their
        access levels to ensure smooth operations.
      </p>
