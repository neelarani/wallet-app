  ...
  return (
    <div className="mt-24">
      ...
      <p className="text-center text-base md:text-xl text-gray-500 mb-6">
        View all your past transactions including deposits, withdrawals, and
        money sent. Keep track of your wallet activity easily.
      </p>

      <Card className="max-w-5xl w-full mx-auto mt-8">
